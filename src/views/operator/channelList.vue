                ...
                <el-row type="flex" class="row-bg" style="flex-wrap: wrap" :gutter="50">
                    <el-col :span="7">
                        <div class="flex-r global-childItem">
                            ...
                            <el-input placeholder="请输入号码名称"  v-model.trim="name" class="aplus-norInp"></el-input>
                        </div>
                    </el-col>
                    ...
                    <el-button  icon="el-icon-plus" class="plusBtn" @click="showEdit(true)">新增</el-button>
                    <!--19BE6B-->
                </el-row>
            ...
            <el-dialog
                ...
                <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                    <el-form-item label="账号" prop="name">
                        <el-input v-model.trim="ruleForm.name"    auto-complete="new-password"  placeholder="请输入账号(由数字和字母组成)"></el-input>
                    </el-form-item>
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
          	if(this.actionType){
          		...
          		this.$api.channel.editChannel(this.ruleForm).then(()=>{
	              this.$message.success("渠道编辑成功!");
	              this.readyAjax();
	              this.dialogVisible=false
	            })
          	}
