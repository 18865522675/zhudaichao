...
function GetPlace(datas) {
    ...
    return datas.map(function (item) {
        ...
        return $("<div/>", {
            ...
            function () {
                if (item.cityList) {
                    return GetSmallPlace(item.cityList)
                }
            }()
        )
    })
...
//  	let arr=$("#cityAreaModal .placegroup input[type='checkbox']");
//		Array.from($("#cityAreaModal .placegroup input[type='checkbox']")).map((index,item)=>{
//			console.log($(this))
//		})
//		$.each(arr,function(index,item){
////			param.map((cItem,cIndex)=>{
////				if(cItem,cIndex)
////			})
////			console.log($(this).attr("data-name"))
//		})
//		console.log(Array.from($("#cityAreaModal .placegroup input[type='checkbox']")))
//  })
	$(".clearCheck").click()
	$.each(param, function (index, value) {
//		console.log(val)
